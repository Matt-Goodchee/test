  ...
  <div class="mobile-nav-header">
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <a href="<?php the_permalink(423); ?>" class="map-toggle nav-button" title="Tap to Open Map" aria-label="Open Map">
          <span>Map</span>
        ...
        <a href="#" id="navbar-toggle" class="navbar-toggle nav-button" title="Tap to Open Menu" aria-label="Open Menu">
          <span>Menu</span>
