...
routeTL.to('.route-map-svg', { opacity: 1 })
  .fromTo('.route-map-svg .route-logos g', {
    opacity: 0,
    scale: 0.95,
  }, {
    opacity: 1,
  ...
  .fromTo('.route-map-svg .main-routes g', {
    opacity: 0,
    scale: 0.98,
  }, {
    opacity: 1,
  ...
  .fromTo('.route-map-svg #city-names-and-background', {
    opacity: 0,
  }, {
    opacity: 1,
    duration: 1
