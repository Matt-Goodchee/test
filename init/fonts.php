...
function rc_enqueue_custom_fonts() {
	...
	wp_enqueue_style('google', "https://fonts.googleapis.com/css2?family=Karla:ital,wght@0,400;0,700;1,400;1,700&family=Montserrat:wght@500;600;700&display=swap", array(), null);
}
