...
* Slug: rc/provider-template
* Description: Example provider page template
* Categories: rc
*/
?>
<!-- wp:kadence/rowlayout {"uniqueID":"_a440a0-1c","columns":1,"customRowGutter":[30,"",""],"colLayout":"equal","tabletPadding":["","md","","md"],"inheritMaxWidth":true,"vsdesk":true,"padding":["md","xxl","0","xxl"],"kbVersion":2,"className":"hero-text-row"} -->
<!-- wp:kadence/column {"borderWidth":["","","",""],"uniqueID":"_7f268b-ca","borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}]} -->
<div class="wp-block-kadence-column kadence-column_7f268b-ca"><div class="kt-inside-inner-col"><!-- wp:heading {"textAlign":"center","level":1} -->
<h1 class="wp-block-heading has-text-align-center">Our Bus Systems</h1>
<!-- /wp:heading --></div></div>
<!-- /wp:kadence/column -->
<!-- /wp:kadence/rowlayout -->

<!-- wp:kadence/rowlayout {"uniqueID":"_692b4d-43","columns":1,"colLayout":"equal","align":"full","tabletPadding":["sm","md","sm","md"],"inheritMaxWidth":true,"padding":["lg","xxl","xl","xxl"],"mobilePadding":["","","",""],"kbVersion":2,"className":"provider-mini-links-row"} -->
<!-- wp:kadence/column {"borderWidth":["","","",""],"uniqueID":"_490cdd-ab","borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}]} -->
<div class="wp-block-kadence-column kadence-column_490cdd-ab"><div class="kt-inside-inner-col"><!-- wp:acf/providers-mini {"name":"acf/providers-mini","mode":"preview"} /--></div></div>
<!-- /wp:kadence/column -->
<!-- /wp:kadence/rowlayout -->

<!-- wp:kadence/rowlayout {"uniqueID":"_218076-8f","tabletLayout":"row","columnGutter":"wider","customGutter":[64,"",""],"colLayout":"equal","align":"full","firstColumnWidth":45,"secondColumnWidth":55,"tabletPadding":["","md","","md"],"inheritMaxWidth":true,"padding":["lg","xxl","xl","xxl"],"mobilePadding":["","","lg",""],"kbVersion":2,"className":"provider-content-row"} -->
<!-- wp:kadence/column {"borderWidth":["","","",""],"uniqueID":"_0185f5-51","borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}],"className":"primary"} -->
<div class="wp-block-kadence-column kadence-column_0185f5-51 primary"><div class="kt-inside-inner-col"><!-- wp:heading {"level":1,"className":"tablet"} -->
<h1 class="wp-block-heading tablet">Provider Name</h1>
<!-- /wp:heading -->
...
<div class="wp-block-group meta-group"><!-- wp:heading {"level":4} -->
...
<!-- wp:kadence/column {"id":2,"borderWidth":["","","",""],"uniqueID":"_4570f1-ab","borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}],"className":"secondary"} -->
<div class="wp-block-kadence-column kadence-column_4570f1-ab secondary"><div class="kt-inside-inner-col"><!-- wp:heading {"level":1,"className":"desktop"} -->
<h1 class="wp-block-heading desktop">Canby Area Transit (CAT)</h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><strong>CAT’s mission is to serve the citizens of Canby, Oregon with accessible, dependable, and efficient public transportation.</strong></p>
<!-- /wp:paragraph -->
...
<h4 class="wp-block-heading" style="padding-top:var(--wp--preset--spacing--20)">CAT provides the following routes and services:</h4>
<!-- /wp:heading -->

<!-- wp:list {"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|40"}}}} -->
<ul style="padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:list-item -->
<li><a href="https://www.canbyoregon.gov/area-transit/page/route-99x-service" target="_blank" rel="noreferrer noopener">99X Fixed Route</a> Service Monday – Saturday</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Local <a href="https://www.canbyoregon.gov/area-transit/page/canby-loop-bus-service" target="_blank" rel="noreferrer noopener">Canby Loop</a> Service Monday - Friday</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://www.canbyoregon.gov/area-transit/page/dial-ride" target="_blank" rel="noreferrer noopener">Dial-A-Ride Paratransit</a> Service Monday – Saturday</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://www.canbyoregon.gov/area-transit/page/shopper-shuttle" target="_blank" rel="noreferrer noopener">Shopper Shuttle</a> Monday - Friday</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<!-- wp:list {"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|40"}}}} -->
<ul style="padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:list-item -->
<li><a href="https://www.canbyoregon.gov/area-transit/page/shopper-shuttle" target="_blank" rel="noreferrer noopener">TriMet</a> and <a href="https://www.clackamas.us/h3s/connects-shuttle" target="_blank" rel="noreferrer noopener">Clackamas County Shuttle</a> at Oregon City Transit Center</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://www.clackamas.us/h3s/connects-shuttle" target="_blank" rel="noreferrer noopener">SMART (Wilsonville)</a> and <a href="http://sctd.org/" target="_blank" rel="noreferrer noopener">SCTD (Mollala)</a> in Canby</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://www.cherriots.org/" target="_blank" rel="noreferrer noopener">Cherriots (Salem)</a> and <a href="https://www.woodburn-or.gov/transit" target="_blank" rel="noreferrer noopener">Woodburn Transportation Service</a> in Woodburn at the Bi-Mart</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">View Routes on Map***</a></div>
<!-- /wp:button -->

<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Plan Your Trip***</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50"}}}} -->
<p style="padding-top:var(--wp--preset--spacing--50)">All buses are equipped with ramps or lifts and bicycle racks. Contact the CAT business office for more information.</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:kadence/column -->
<!-- /wp:kadence/rowlayout -->

<!-- wp:kadence/rowlayout {"uniqueID":"_d0470e-09","columns":3,"columnGutter":"custom","tabletGutter":"custom","customGutter":[100,50,""],"colLayout":"first-row","bgColor":"#FAFAF2","align":"full","tabletPadding":["","md","","md"],"inheritMaxWidth":true,"bgColorClass":"ivory","padding":["lg","xxl","xl","xxl"],"mobilePadding":["","","lg",""],"kbVersion":2,"className":"provider-ticket-row"} -->
...
<!-- wp:kadence/column {"borderWidth":["","","",""],"uniqueID":"_8976a4-3e","borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}],"className":"primary"} -->
<div class="wp-block-kadence-column kadence-column_8976a4-3e primary"><div class="kt-inside-inner-col"><!-- wp:heading {"level":3} -->
...
<figure class="wp-block-table is-style-regular" style="margin-bottom:var(--wp--preset--spacing--50)"><table><tbody><tr><td>Route 99X (Mon-Fri)</td><td>$1</td></tr><tr><td>Route 99X (Saturday)</td><td>Free</td></tr><tr><td>Canby Loop</td><td>$1</td></tr><tr><td>Shopper Shuttle</td><td>Free</td></tr></tbody></table></figure>
<!-- /wp:table -->

<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading">How to buy single trip tickets:</h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Pay drivers exact change. Drivers don’t carry cash.</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:kadence/column -->
...
<!-- wp:table {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"className":"is-style-regular"} -->
<figure class="wp-block-table is-style-regular" style="margin-bottom:var(--wp--preset--spacing--50)"><table><tbody><tr><td>24 Ride Punch Pass (no expiration date)</td><td>$20</td></tr><tr><td>Monthly Pass (unlimited number of rides)</td><td>$20</td></tr></tbody></table></figure>
<!-- /wp:table -->

<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading">How to buy passes:</h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>There are three ways to purchase a bus pass.</p>
<!-- /wp:paragraph -->

<!-- wp:list {"ordered":true} -->
<ol><!-- wp:list-item -->
<li>Purchase a pass from a CAT bus driver.*<br>Bus drivers accept cash only, exact change.</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Purchase a pass at the CAT office located at:<br>195 S Hazel Dell Way, Suite C<br>Canby, OR 97013<br>We accept cash, check, or credit card.</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Purchase a pass over the phone or by email. <br>Call <a href="tel:+1-503-266-4022">503-266-4022</a> or e-mail <a href="mailto:cat@canbyoregon.gov">cat@canbyoregon.gov</a>.</li>
<!-- /wp:list-item --></ol>
<!-- /wp:list --></div></div>
<!-- /wp:kadence/column -->

<!-- wp:kadence/column {"borderWidth":["","","",""],"uniqueID":"_6b6fc3-6b","padding":["lg","","",""],"mobilePadding":["0","","",""],"borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}],"className":"full-width outro"} -->
<div class="wp-block-kadence-column kadence-column_6b6fc3-6b full-width outro"><div class="kt-inside-inner-col"><!-- wp:paragraph -->
<p>* Drivers will sell passes at locations where it is safe to park the bus off the roadway. Please be considerate of the drivers’ need to be safe and stay on schedule.</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:kadence/column -->
<!-- /wp:kadence/rowlayout -->
...
<!-- wp:kadence/tab {"id":2,"uniqueID":"_85cda4-67","className":"wheelchair"} -->
<div class="wp-block-kadence-tab kt-tab-inner-content kt-inner-tab-2 kt-inner-tab_85cda4-67 wheelchair"><div class="kt-tab-inner-content-inner"></div></div>
<!-- /wp:kadence/tab -->

<!-- wp:kadence/tab {"id":3,"uniqueID":"_5d55ee-99","className":"bike"} -->
<div class="wp-block-kadence-tab kt-tab-inner-content kt-inner-tab-3 kt-inner-tab_5d55ee-99 bike"><div class="kt-tab-inner-content-inner"></div></div>
<!-- /wp:kadence/tab -->

<!-- wp:kadence/tab {"id":4,"uniqueID":"_a4129a-12"} -->
<div class="wp-block-kadence-tab kt-tab-inner-content kt-inner-tab-4 kt-inner-tab_a4129a-12"><div class="kt-tab-inner-content-inner"></div></div>
<!-- /wp:kadence/tab --></div></div></div>
<!-- /wp:kadence/tabs --></div></div>
<!-- /wp:kadence/column -->
<!-- /wp:kadence/rowlayout -->

<!-- wp:kadence/rowlayout {"uniqueID":"_df7e17-f0","columns":3,"tabletLayout":"row","columnGutter":"wider","customGutter":[64,"",""],"colLayout":"first-row","bgColor":"#FAFAF2","align":"full","tabletPadding":["","md","","md"],"inheritMaxWidth":true,"bgColorClass":"ivory","padding":["lg","xxl","xl","xxl"],"mobilePadding":["","","lg",""],"kbVersion":2,"className":"provider-outro-row grid-custom"} -->
...
<!-- wp:kadence/column {"id":3,"borderWidth":["","","",""],"uniqueID":"_8e906f-4d","collapseOrder":3,"borderStyle":[{"top":["","",""],"right":["","",""],"bottom":["","",""],"left":["","",""],"unit":"px"}],"className":"secondary"} -->
<div class="wp-block-kadence-column kadence-column_8e906f-4d secondary"><div class="kt-inside-inner-col"><!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Optional Area for Photos and Text</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><strong>This section can be used for news, announcements, or anything else specific to this bus system.</strong></p>
<!-- /wp:paragraph -->
